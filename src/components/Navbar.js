  ...
  return (
    <nav className="container mx-auto px-4 py-6 flex items-center justify-between bg-gray-900 text-white">
      ...
      <div className="hidden md:flex items-center gap-8">
        ...
        {/* Build Link */}
        <a href="#" className="hover:text-[#00FF7F] transition-colors font-jaini text-xl">Build</a>
      ...
      <div className="hidden md:flex items-center gap-6">
        <a href="#" className="hover:text-[#00FF7F] transition-colors font-jaini text-3xl">Login</a>
        <button className="bg-[#00FF7F] text-black px-6 py-2 rounded-full font-medium hover:bg-[#00CC6A] font-jaini text-3xl transition-colors">
          Get Started
        </button>
      </div>
    </nav>
